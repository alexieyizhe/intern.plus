...
fs.readFile('./data-reviews', 'utf8' , (err, data) => {
  ...
  data.split("\n").forEach(v => {
    const data = v.match(/^\('([a-zA-Z0-9]{25})','([0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}:[0-9]{2}.[0-9]{6})','([0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}:[0-9]{2}.[0-9]{6})',([0-9]+),('.*'|NULL),'(.*)',(-{0,1}[0-9]+),'(.*)','(monthly|weekly|hourly)',([0-9]\.[0-9]),(?:([0-9]\.[0-9])|(NULL)),(?:([0-9]\.[0-9])|(NULL)),(?:([0-9]\.[0-9])|(NULL)),(?:'([a-zA-Z0-9]+(?:,[a-zA-Z0-9]+)*)'|(NULL)),(0|1),(0|1),(.*)\)$/);
    try {
